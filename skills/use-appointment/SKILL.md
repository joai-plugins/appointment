...
- `appointment-request-approve` (collect, inline) — Notify team members about a new appointment request that needs manual approval. Used by service businesses like barbers, restaurants, and consultants to review and approve customer booking requests.
